            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                        <a class="js-arrow" href="#"><a class="nav-link" href="{{ ('caremad') }}/index.html">
                        ...
                        <h2 class="title-1">ADMINISTRATOR</h2>
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{url('frontend/images/icon/avatar-06.jpg') }}" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{url('frontend/images/icon/avatar-04.jpg') }}" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                ...
                                <div class="account-wrap">
                                    ...
                                    <div class="image">
                                            <img src="{{url('frontend/images/icon/aida.jpg') }}" alt="Nur Aida" />
                                        </div>
                                        <div class="content">
